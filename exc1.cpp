...
int openpose()
{
	...
	//读入网络模型和权重文件
	String modelTxt = "D:/Project_data/C++/Project_1_6/openpose_pose_coco.prototxt";
	String modelBin = "D:/Project_data/C++/Project_1_6/pose_iter_440000.caffemodel";
	...
	VideoCapture cap;
	cap.open("D:/Project_data/C++/Project_1_6/yolov.mp4");
